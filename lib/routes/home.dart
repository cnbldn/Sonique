...
class _HomeState extends State<Home> {
  ...
  Future<void> _initStreams() async {
    ...
    _popularStream = FirebaseFirestore.instance
        .collection('reviews')
  ...
  Widget _reviewBox(
      {required Map<String, dynamic> r, required String docId}) {
              ...
              children: [
                ...
                StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (_, s) {
                      ...
                      return Text("$likes Likes, $cmt Comments",
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
  ...
  void _openReview(
      Map<String, dynamic> review, String docId, bool startWithKeyboard) {
    Navigator.push(
      context,
      MaterialPageRoute(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Center(
                child: SvgPicture.asset('assets/sonique.svg',
                    width: 155, height: 22),
              ),
            ),
            ...
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (_, snap) {
                ...
                final list = byAlbum.values.toList()
                  ..sort((a, b) {
